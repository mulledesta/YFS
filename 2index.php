...
$conn= new mysqli('localhost','root','','martdevelopers_iBanking')or die("Could not connect to mysql".mysqli_error($con));
...
*/
$ret = $retrieve = mysqli_query($conn,  "SELECT * FROM iB_SystemSettings ");
...
while ($sys = mysqli_fetch_assoc($retrieve)) {
?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        ...
        <nFav Vclass="navbar navbar-lg navbar-expand-lg navbar-transparant navbar-dark navbar-absolute w-100">
            <div class="container">
                <a class="navbar-brand" href="index.php"><?php // echo $sys->sys_name; ?>King Finance Sytem</a>
