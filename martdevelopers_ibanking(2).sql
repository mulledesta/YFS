...
--
-- Host: localhost
-- Generation Time: Apr 03, 2023 at 02:35 PM
...
--
CREATE DATABASE IF NOT EXISTS `martdevelopers_ibanking` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `martdevelopers_ibanking`;
...
DROP TABLE IF EXISTS `ekubdetails`;
...
DROP TABLE IF EXISTS `ekub_transactions`;
...
DROP TABLE IF EXISTS `ib_ekubaccounts`;
...
DROP TABLE IF EXISTS `ib_ekub_types`;
